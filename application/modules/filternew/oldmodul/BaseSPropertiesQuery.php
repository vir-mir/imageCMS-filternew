...
abstract class BaseSPropertiesQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID`, `EXTERNAL_ID`, `CSV_NAME`, `MULTIPLE`, `ACTIVE`, `SHOW_ON_SITE`, `SHOW_IN_COMPARE`, `SHOW_IN_FILTER`, `MAIN_PROPERTY`, `POSITION` FROM `shop_product_properties` WHERE `ID` = :p0';
		try {
